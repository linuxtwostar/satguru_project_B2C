...
public class GeoLocation {
	...
	//public static final double INITIAL_DISTANCE = 10; // distance in KM
	 ...
	 */
	public static GeoLocation fromDegrees(double latitude, double longitude) throws Exception{
		CallLog.info(1, "inside fromDegrees ==");
		...
		result.checkBounds();
		CallLog.info(1, "inside fromDegrees =="+result);
		return result;
	}
